...
function displayorder() {
  array_product01.forEach((item) => {
    ...
    order02.innerHTML =`<div class="row m-0" >
          ...
          <div class="col-12 mb-3 px-0" style="font-size:15px"><span class="me-2">付款方式</span>${method1[0]}</div>
          <div class="col-12 mb-3 px-0" style="font-size:15px"><span class="me-2">運送方式</span>${method2[0]}</div>
          <hr class="mt-2">
        </div> `
